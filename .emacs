...
;; Set the delete word function to Ctrl-Backspace to conform with GUI.
;; Also override ^H as that is triggered by default
        ...
        (progn
          ...
          (if end
            ...
            (if space-pos
              ...
              (backward-kill-word 1))))
      ( cp (- cp 1)))         ;; word is non-english word
    ))
(global-set-key  [C-backspace]
                 'aborn/backward-kill-word)

(global-set-key [(control ?h)] 'aborn/backward-kill-word)
